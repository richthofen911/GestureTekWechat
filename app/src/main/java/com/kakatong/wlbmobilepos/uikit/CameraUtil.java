package com.kakatong.wlbmobilepos.uikit;

import java.io.BufferedOutputStream;
import java.io.File;
import java.io.FileOutputStream;

//import com.tencent.mm.sdk.algorithm.MD5;
...
import com.kakatong.wlbmobilepos.Util;
...
public final class CameraUtil {
	...
	public static String resolvePhotoFromIntent(final Context ctx, final Intent data, final String dir) {
		...
		if (cu != null && cu.getCount() > 0) {
			...
			try {
				final String fileName = (DateFormat.format("yyyy-MM-dd-HH-mm-ss", System.currentTimeMillis()).toString().getBytes()) + "END";
				filePath = dir + fileName;
